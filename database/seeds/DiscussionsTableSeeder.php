...
class DiscussionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $d1 = [
            'title'         => $t1,
            'content'       => 'Lorem ipsum dolor sit amet, purto invenire id qui. Equidem delicata expetendis usu ea',
            'channel_id'    => 1,
            'user_id'       => 2,
            'slug'          => str_slug($t1)
        ];
        ...
        $d2 = [
            'title'         => $t2,
            'content'       => 'Vue.js pagination Lorem ipsum dolor sit amet, purto invenire id qui. Equidem delicata expetendis usu ea',
            'channel_id'    => 2,
            'user_id'       => 1,
            'slug'          => str_slug($t2)
        ];
